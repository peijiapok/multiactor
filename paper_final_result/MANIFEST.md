...
| Fig. instrument counterfactual | `instrument_counterfactual_20260717.csv` (20-seed+CIs; 5-seed `instrument_counterfactual_20260630.csv` retained) | `plot_instrument_counterfactual_20260630.py` |
...
| Fig. equal-budget incentive comparison | `incentive_comparison_20260717.csv` (20-seed+CIs) | `run_incentive_comparison_20260716.py` + `plot_incentive_comparison_20260716.py` |
